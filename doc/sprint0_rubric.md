...
**Github:** [https://github.com/UTSCCSCC01/finalprojects22-byte-peeps]  
...
## summary.md (Max 8 marks)
  ...
  - Key users have been identified clearly (max 2 marks) 
    ...
    Your mark: 2 
    Feedback: Couple more users could have been identified as a potential user like company admin stuff e.t.c
  ...
  - Scenarios have been described clearly (max 2 marks)    
    ...
    Your mark: 1 Feedback: Walter White/Alice was not mentioned in the personas. Need to use the same people in scenarios as in Personas
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  Feedback: Depending on how much time you put, this might turns out to be more work than you anticipate at this point. Integrating ML models to your website might be a challenging task, and same for integrating different social media platforms. But I belive, once you are able to integrate one of them using their APIs, others should be similar.  
