...
## Daily Stand-ups (max 10 marks)
  ...
  Feedback: Sprint 3 Standup 1 missing for One member (Discord name: Giani)
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1
    - BYT-50 Subtasks not assigned
    - No subtasks created for BYT-162
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1
    - COS missing for BYT-162
    - Description and COS missing for BYT-170
...
## Sprint Completion (Max 20 marks) 
  ...
  - BYT-91 completed on July 19 (After the deadline) (See the Jira Report for Sprint 3)
